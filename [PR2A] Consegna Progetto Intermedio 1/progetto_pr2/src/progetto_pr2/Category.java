...
public interface Category<E extends Data> {
	/*
	 * Overview: Categoria di dato presente in una bacheca. Una categoria ha un nome, un insieme di elementi della bacheca
	 *  che sono di tale categoria e un insieme di amici che possono visualizzare i contenuti della bacheca di quella categoria.
	 * 
	 * Typical element: 
	 * 	<name, { el_0, ..., el_esize() - 1) }, 
	 * 		   { friend_0, ..., friend_fsize() - 1) } >
	 * 
	 * è una tripla tale che:
	 * 		- name è il nome della categoria 
	 * 		- il secondo elemento è un insieme di oggetti di tipo E 
	 * 		- il terzo elemento è un insieme di User "amici" che possono visualizzare gli elementi della categoria 
	 * 		- esize() corrisponde al numero di elementi associati alla categoria 
	 * 		- fsize() corrisponde al numero di "amici" associati alla bacheca
	 * 
	 * Proprietà: 
	 * 		- name != null 
	...
	// restitutisce il numero di amici che hanno accesso agli elementi della categoria
	public int fsize();
	/*
	 * EFFECTS: restitutisce il numero di amici che hanno accesso agli elementi della categoria.
	 */

	// restituisce true se friend può visualizzare gli elementi nella categoria, false altrimenti
	 ...
	 * EFFECTS: restituisce true se friend può visualizzare gli elementi nella categoria, false altrimenti
	 */
	...
	//restituisce una lista contenente le copie degli elementi di questa categoria
	public List<E> getElements();
	/*
	 * EFFECTS: restituisce una lista contenente le copie degli elementi di questa categoria
	 */

	//Aggiunge un like al dato data
	public void addLike(E data);
	/*
	 * MODIFIES: this
	 * EFFECTS: se data è presente nella categoria, aggiunge un like alla copia all'interno della categoria 
	 */
	
	//metodo per la verifica della invariante di rappresentazione
	public boolean checkRep();
	/*
	 * EFFECTS: true se l'invariante di rappresentazione è rispettata, false altrimenti
	 */
